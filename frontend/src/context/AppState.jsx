...
const defaultAnimes = [
  {
    ...
    states: [
      ...
      { id: 's3', name: '슬픔', spritePath: '', rows: 1, cols: 1, duration: 150, frameDurations: [150], chats: [] },
      { id: 's4', name: '분노', spritePath: '', rows: 1, cols: 1, duration: 150, frameDurations: [150], chats: [] },
    ],
  },
];
